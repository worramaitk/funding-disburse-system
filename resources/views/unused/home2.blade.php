    ...
    <body class="bg-white dark:bg-gray-800">
        ...
        <section id="hero">
            <div class="content-center">
                <img src="{{ asset('img/PSU_Engineering_1610764_267586400097437_5007053788823839029_n.jpg') }}" alt="" />
            </div>
            <div class="text-center text-sm text-gray-100 dark:text-gray-600">
                สร้างด้วย Laravel version{{ Illuminate\Foundation\Application::VERSION }} (PHP version{{ PHP_VERSION }})
            </div>
        </section>
