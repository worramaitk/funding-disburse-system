...
<html lang="en">
  ...
  <body>
    <!-- Navbar -->
    <nav class="relative container mx-auto p-6 bg-black dark:bg-black">
      <!-- Flex container -->
      <div class="flex items-center justify-between">
        <!-- Logo -->
        <div class="p-2 flex">
          <img class="object-scale-down h-10 bg-white" src="{{ asset('img/logo01.png') }}" alt="" />
          <button class="rounded-full bg-transparent text-white">ระบบเบิกจ่ายเงินรายวิชาโครงงาน คณะวิศวกรรมศาสตร์ มหาวิทยาลัยสงขลานครินทร์</button>
        </div> 
        <!-- Menu Items --> 
        <div class="hidden space-x-6 md:flex">
            <button class="rounded-full p-2 bg-blue-800 text-blue-200 ">Home</button>
